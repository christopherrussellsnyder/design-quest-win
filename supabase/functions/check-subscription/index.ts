...
const TIERS: Record<string, string> = {
  "prod_UIawRkLpiYZXzx": "starter",
  "prod_UIax8nuGLyp6xt": "pro",
  "prod_UIaxJi5q8GgkP0": "agency",
};
...
serve(async (req) => {
  ...
  try {
    ...
    if (customers.data.length === 0) {
      return new Response(JSON.stringify({ subscribed: false, tier: null, subscription_end: null, trial_end: null }), {
