                  ...
                  <div className="p-3 rounded-lg border border-border bg-muted/30 space-y-3">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-sm font-semibold text-foreground">AI-Generated Image</h4>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button
                          variant="ghost"
                        ...
                        >
                          {showStyleInput ? 'Hide style' : 'Custom style'}
                        </Button>
                        <Button
                          size="sm"
                  ...
                  <div className="p-3 rounded-lg border border-border bg-muted/30 space-y-3">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-sm font-semibold text-foreground">AI-Generated Video</h4>
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => setShowMotionInput((v) => !v)}
                          className="h-7 text-xs"
                        >
                          {showMotionInput ? 'Hide motion' : 'Custom motion'}
                        </Button>
                        <Button
                          size="sm"
                          ...
                          className="gap-1 h-8"
                          title={!generatedImage ? 'Generate an image first' : ''}
                        >
                          {generatingVideo ? (
                    ...
                    {showMotionInput && (
                      <input
                        ...
                        placeholder="e.g. slow zoom-in, gentle pan left, falling confetti..."
                        className="w-full bg-background border border-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary"
                      />
                    )}
                    ...
                    {generatedVideo ? (
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          <Button size="sm" variant="outline" className="h-7 text-xs gap-1" asChild>
                            <a href={generatedVideo} target="_blank" rel="noopener noreferrer" download>
                              Download
                            </a>
                          </Button>
                          <Button
                            ...
                            variant="ghost"
                            className="h-7 text-xs gap-1"
                            onClick={() => copyToClipboard(generatedVideo, 'video-url')}
                          >
                            {copiedField === 'video-url' ? <Check className="w-3 h-3 text-green-500" /> : <Copy className="w-3 h-3" />}
                            Copy URL
                          </Button>
                          <span className="text-[10px] text-muted-foreground ml-auto">Saved to Media Library</span>
                        </div>
                      ...
                      <div className="aspect-video w-full rounded-lg border border-border bg-muted/50 flex items-center justify-center">
                        <div className="flex flex-col items-center gap-2 text-muted-foreground">
                          <Loader2 className="w-6 h-6 animate-spin text-primary" />
                          <p className="text-xs">Rendering video (1–2 min)...</p>
                        </div>
                      </div>
                    ) : (
                      <p className="text-xs text-muted-foreground">
                        {generatedImage
                          ? 'Animate your generated image into a short cinematic clip.'
                          : 'Generate an image first, then animate it into a short video clip.'}
                      </p>
                    )}
                  </div>
