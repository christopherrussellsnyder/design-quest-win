            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg border transition-colors ${
                  isActive ? 'border-[hsl(var(--primary))] bg-[hsl(var(--primary))]/5' : 'border-border bg-background/50'
                }`}
              >
                <Building2 className={`h-5 w-5 ${isActive ? 'text-[hsl(var(--primary))]' : 'text-muted-foreground'}`} />
                {isEditing ? (
                  <Input
                    value={editName}
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    ...
                    {isActive && <Badge className="text-xs bg-[hsl(var(--primary))]">Active</Badge>}
                  </div>
                )}
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            <Plus className="h-4 w-4 text-[hsl(var(--primary))]" /> Add a workspace
          </CardTitle>
          <CardDescription>
            {canCreateMore
        ...
        <CardContent>
          {canCreateMore ? (
            ...
            <Button onClick={() => navigate('/pricing')} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]">
