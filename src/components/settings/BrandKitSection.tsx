...
export function BrandKitSection() {
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-8 text-center space-y-4">
            <Lock className="h-10 w-10 mx-auto text-[hsl(var(--primary))]" />
            <div>
            ...
            <Button onClick={() => navigate('/pricing')} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]">Upgrade to Agency</Button>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2"><Palette className="h-4 w-4 text-[hsl(var(--primary))]" /> Identity</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            {kit.logo_url ? (
              ...
              <div className="h-16 w-16 rounded bg-[hsl(var(--muted))] border border-[hsl(var(--border))] flex items-center justify-center text-xs text-muted-foreground">No logo</div>
            )}
            <div>
              <input
                id="logo-upload"
          ...
          <Button onClick={save} disabled={saving} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]">
