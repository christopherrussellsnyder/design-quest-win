    ...
    return (
      <div className="min-h-screen bg-background p-8">
        <div className="max-w-2xl mx-auto text-center space-y-4 pt-20">
          <Lock className="h-12 w-12 mx-auto text-[hsl(var(--primary))]" />
          ...
          <div className="flex gap-3 justify-center">
            ...
            <Button className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]" onClick={() => navigate('/pricing')}>Upgrade to Agency</Button>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b border-border px-6 py-4 flex items-center justify-between">
        ...
        <Button onClick={() => setDialogOpen(true)} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]"><Plus className="h-4 w-4 mr-2" /> New report</Button>
      </header>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={r.is_public ? 'default' : 'outline'} className={r.is_public ? 'bg-[hsl(var(--primary))]' : ''}>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={generate} disabled={generating} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))]">
