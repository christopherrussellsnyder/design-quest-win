      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <AnimatedSection className="mt-16" delay={0.3}>
            <div className="bg-[#16171A] border border-[#2A2B2E] rounded-2xl aspect-video flex items-center justify-center relative overflow-hidden group cursor-pointer">
              <div className="absolute inset-0 bg-gradient-to-br from-[#CC0000]/10 to-transparent" />
              <div className="relative z-10 text-center">
                <div className="w-20 h-20 rounded-full bg-[#CC0000] flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform shadow-[0_0_30px_rgba(204,0,0,0.4)]">
                  <ArrowRight className="w-8 h-8 text-white ml-1" />
                </div>
                <p className="text-[#A0A0A8] text-sm">Watch 2-Minute Demo</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
