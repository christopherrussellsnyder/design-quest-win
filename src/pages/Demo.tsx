...
const VideoPlayer = () => {
  ...
  // Styled placeholder
  return (
    <div className="w-full aspect-video rounded-2xl bg-[hsl(var(--card))] border border-[hsl(var(--primary))]/30 flex items-center justify-center relative overflow-hidden"
      ...
      <div className="relative z-10 text-center">
        ...
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-[hsl(var(--primary))] flex items-center justify-center mx-auto cursor-pointer shadow-[0_0_30px_hsl(var(--primary) / 0.4)]"
        >
        ...
        <nav className="border-b border-[hsl(var(--border))] px-4 py-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-[hsl(var(--muted-foreground))]">
              ...
              <Link to="/demo" className="text-[hsl(var(--primary))]">Demo</Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {steps.map((step, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: i * 0.15 }}
                  className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-2xl p-8 text-center">
                  <div className="w-12 h-12 rounded-full bg-[hsl(var(--primary))] flex items-center justify-center mx-auto mb-5 text-white font-black text-lg shadow-[0_0_20px_hsl(var(--primary) / 0.3)]">
                    {i + 1}
                  </div>
        ...
        <section className="py-24 px-4 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/signup" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--primary-dark))] text-white font-bold rounded-lg hover:scale-105 transition-all shadow-[0_0_30px_hsl(var(--primary) / 0.3)]">
                Create Your Free Account <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="/#pricing" className="text-[hsl(var(--muted-foreground))] hover:text-white transition-colors text-sm underline underline-offset-4">
                View Pricing
              </Link>
            </div>
          </div>
