        ...
        <nav className="border-b border-[#2A2B2E] px-4 py-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-[#A0A0A8]">
              ...
              <Link to="/how-it-works" className="text-[#CC0000]">How It Works</Link>
        ...
        <section className="py-24 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <span className="inline-block px-3 py-1 text-xs uppercase tracking-widest text-[#CC0000] border border-[#CC0000]/30 rounded-full mb-6">
                Under the Hood
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-black mb-6" style={{ fontFamily: 'Arial Black, sans-serif', letterSpacing: '2px' }}>
                How Korex{' '}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CC0000] to-[#FF1A1A]">Actually Works</span>
              </h1>
        ...
        <section className="py-16 px-4 bg-[#0A0A0A]">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#A0A0A8] max-w-2xl mx-auto">Six stages, running every time you click "Generate Strategy."</p>
            </div>
            <div className="space-y-4">
              {pipelineSteps.map((step, i) => (
                <motion.div
                  ...
                  className="flex gap-5 bg-[#16171A] border border-[#2A2B2E] rounded-2xl p-6 hover:border-[#CC0000]/40 transition-all"
                >
                  <div className="shrink-0 w-12 h-12 rounded-xl bg-[#CC0000]/10 flex items-center justify-center">
                    <step.icon className="w-6 h-6 text-[#CC0000]" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold mb-1.5">{step.title}</h3>
                    <p className="text-[#A0A0A8] text-sm leading-relaxed">{step.body}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#A0A0A8] max-w-2xl mx-auto">Every feature is built on the same principle: real data in, personalized output out.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {otherFeatures.map((f, i) => (
                <motion.div
                  ...
                  className="bg-[#16171A] border border-[#2A2B2E] rounded-2xl p-6"
                >
                  ...
                  <p className="text-[#A0A0A8] text-sm leading-relaxed">{f.body}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 bg-[#0A0A0A]">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#A0A0A8] max-w-2xl mx-auto">What we do differently — and why it produces measurably better strategies.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {edges.map((e, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: i * 0.05 }}
                  className="bg-[#16171A] border border-[#2A2B2E] rounded-xl p-5"
                >
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-2 h-2 mt-2 rounded-full bg-[#CC0000]" />
                    <div>
                      <h4 className="font-bold text-[#EEEEEE] mb-1">{e.edge}</h4>
                      <p className="text-sm text-[#A0A0A8] leading-relaxed">{e.competitor}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <footer className="bg-[#060606] border-t border-[#2A2B2E] py-8 px-4">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-xs text-[#6B6B73]">
              ...
              <Link to="/how-it-works" className="hover:text-[#CC0000] transition-colors">How It Works</Link>
