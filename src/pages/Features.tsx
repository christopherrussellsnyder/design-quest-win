        ...
        <nav className="border-b border-[hsl(var(--border))] px-4 py-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-[hsl(var(--muted-foreground))]">
              <Link to="/features" className="text-[hsl(var(--primary))]">Features</Link>
        ...
        <section className="py-24 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }}>
              <Link to="/signup" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--primary-dark))] text-white text-lg font-bold rounded-lg hover:scale-105 transition-all shadow-[0_0_30px_hsl(var(--primary) / 0.3)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: i * 0.1 }}
                  className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-2xl p-8 hover:border-[hsl(var(--primary))]/50 transition-all group">
                  <div className="w-14 h-14 rounded-xl bg-[hsl(var(--primary))]/10 flex items-center justify-center mb-6 group-hover:bg-[hsl(var(--primary))]/20 transition-colors">
